    ...
    <>
          ...
          <ul className="hidden font-josefin sm:text-[16px] md:flex gap-10 text-white mx-4">
            ...
            <li className="flex items-center relative">
              <Link href={"/cart"} className="flex items-center">
                ...
                <span className="absolute font-normal -top-2 left-3 bg-red-600 text-white text-xs rounded-full px-2 py-0.5 flex items-center justify-center">
                  {items.length}
                </span>
              </Link>
            </li>
      ...
      <div className="w-full sm:px-[135px] flex justify-center py-6">
        <div className="w-full max-w-screen-xl h-[40px] bg-white flex flex-row p-2 sm:p-6 sm:py-1 sm:gap-32 justify-between items-center">
          <ul>
            <li>
              <h1 className="font-bold text-[30px] sm:text-[34px] font-josefin">
            ...
            <li>
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-white text-gray-800 shadow-lg rounded-md p-2 w-[150px] left-[-10px] absolute z-10">
                  <DropdownMenuSeparator className="border-gray-200" />
                  <DropdownMenuItem className="hover:bg-gray-100 cursor-pointer">
                    <Link href={"/product/featured-products"}>
                      Featured Product
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="hover:bg-gray-100 cursor-pointer">
                    <Link href={"/product/trending-products"}>
                      Trending Products
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
